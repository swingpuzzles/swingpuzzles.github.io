import { Mesh, QuadraticEase, Animation, EasingFunction, Quaternion, Vector3 } from "@babylonjs/core";
import ctx from "../common/SceneContext";
import IPuzzleAnimation from "./IPuzzleAnimation";

class NormalizePositionRotationAnimation implements IPuzzleAnimation {
    private _destinationX!: number;
    private _destinationZ!: number;
    
    public set destinationX(value: number) {
        this._destinationX = value;
    }

    public set destinationZ(value: number) {
